...
const Login = () => {
     ...
     return (
          <div className="login">
               <div className="container" style={{ height: isLogin ? "647px" : "1164px" }}>
                    <div className="left">
                         ...
                         />
                         <p className="context">Để mỗi lựa chọn của bạn tốt hơn nhờ FINDHOME</p>
                    </div>
                    <div className="right">
                         ...
                         {!isLogin ? (
                              <>
                                   <p className="context-4">
                                        ...
                                        <Link className="rules"> Điều khoản sử dụng </Link> của
                                        chúng tôi
                                   </p>
