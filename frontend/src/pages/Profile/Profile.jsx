...
const Profile = () => {
     ...
     const [identityCardDate, setIdentityCardDate] = useState(userData.identityCardDate);
     ...
     useEffect(() => {
          const formattedAddress = `${selectedWard ? `${selectedWard.value},` : ""}   ${
