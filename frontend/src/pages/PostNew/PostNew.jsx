               ...
               <div className="post-container">
                    ...
                    <form action="">
                         ...
                         <section className="info-basic pb-3">
                              ...
                              <div className="content-3">
                                   <ul>
                                        ...
                                        <li>
                                             Số lượn ảnh tối đa tùy theo loại tin chọn ở bước tiếp
                                             theo
                                        </li>
                                   </ul>
                              </div>
                         ...
                         <div className="action-button">
                              <Link className="button button__thirdary button-postnew">
                                   Đăng tin
                              </Link>
                              <Link className="button button__thirdary">lưu nháp</Link>
                         </div>
                    </form>
               </div>
          </div>
