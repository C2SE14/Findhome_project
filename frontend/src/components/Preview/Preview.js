                              ...
                              <div className="content">
                                   <div className="detail">
                                        ...
                                        <div className="address">
                                             ...
                                             <span>
                                                  {payload.address ? payload.address : "địa chỉ"}
                                             </span>
                                        </div>
                                        <div className="price">
                                             ...
                                             <span>
                                                  {payload.price ? `${payload.price} VNĐ` : ""}
                                             </span>
                                        </div>
                                        <div className="time">
                                        ...
                                        <div className="info">
                                             <div className="frontage">
                                                  ...
                                                  <p>
                                                       {payload.frontispiece
                                                            ? `${payload.frontispiece} m`
                                                            : ""}
                                                  </p>
                                             </div>
