...
export const FormInfo = ({
     ...
     const [isBroker, setIsBroker] = useState(payload.brokerModel.broker || false);
     ...
     const handleDeleteImage = (imageData) => {
          ...
          const newImagesPreview = imagesPreview.filter((image) => image !== imageData);
                    ...
                    <div className="content between ">
                         ...
                         {activeIndex === 0 ? (
                              <Select
                                   ...
                                   setPayload={(e) =>
                                        setPayload({ ...payload, legalDocument: e.target.value })
                                   }
                                   selectOption={true}
                              />
                         ) : (
                    ...
                    {activeIndex === 0 ? (
                         ...
                         <div className="content between ">
                              <Select
                                   ...
                                   setPayload={(e) =>
                                        setPayload({ ...payload, payment: e.target.value })
                                   }
                                   selectOption={true}
                              />
                              <InputValue
               ...
               <div className="form-info">
                    ...
                    <div className="content between">
                         <InputValue
                              ...
                              name={"fullName"}
                              className={"title-name"}
                              value={payload.brokerModel.fullName}
                              classParent={"info-2"}
                              setValue={setPayload}
                         />
                         <InputValue
                              ...
                              name={"phoneNumber"}
                              className={"title-name"}
                              value={payload.brokerModel.phoneNumber}
                              classParent={"info-2"}
                              setValue={setPayload}
                         />
                    </div>
                    <div className="content between">
                         <InputValue
                              ...
                              name={"addressUser"}
                              className={"title-name"}
                              value={payload.brokerModel.address}
                              classParent={"info-2"}
                              setValue={setPayload}
                         />
                         <InputValue
                              ...
                              name={"email"}
                              className={"title-name"}
                              value={payload.brokerModel.email}
                              classParent={"info-2"}
                              setValue={setPayload}
                         />
                    </div>
